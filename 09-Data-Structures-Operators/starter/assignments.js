...
const titleAuthor = {bookTitle: title , bookAuthor : author } ;
({bookTitle,bookAuthor} = titleAuthor) ;
...
for (let abc = 0; abc < books.length; abc++) {
books[abc].onlineContent ?? console.log(`"${books[abc].title}" provides no data about its online content`);
}
